...
rg -q 'private let maxPendingFrameCount = 3' "$bridge_file"
rg -q 'private var lastReportedRepetitions = 0' "$bridge_file"
rg -q 'private var pendingFrames: \[PendingFrame\]' "$bridge_file"
rg -q 'pendingFrames.append\(item\)' "$bridge_file"
rg -q 'pendingFrames.removeFirst' "$bridge_file"
rg -q 'let countedNewRepetition = update\.repetitions > lastReportedRepetitions' "$bridge_file"
rg -q 'lastReportedRepetitions = update\.repetitions' "$bridge_file"
rg -q 'if countedNewRepetition \{' "$bridge_file"
rg -q 'discardPendingFrames\(\)' "$bridge_file"
